/** DEVELOPED ON APPLE M3 WITH 16GB DDR5 DRAM AND MACOS SEQUOIA 15.1 */

/**
 * @file   num7.cpp
 * @author Giovanni Cipriani <giocip7@gmail.com>
 * @date   2025
 * @brief  num7 ISO C++14 Standard 64-BIT LIBRARY, ARBITRARY-PRECISION GENERAL PURPOSE ARITHMETIC-LOGIC DECIMAL CLASS FOR APPLE SILICON ARCHITECTURE
 *
 * @see https://github.com/giocip/MACOS_num7
 */
...
namespace num7 {          // STARTING CURLY BRACKET num7 namespace
    ...
    NUM::NUM(double n) {
        ...
        char s[32];
        snprintf(s, (size_t)sizeof(s), "%.15f", n);
  ...
  /// NUM IN-LINE /// RETURN OBJECT *this COPIED ON b, CODE: NUM a("-3.14"), b("2.71"); print(b, " => "); a.copy(b); print(b, "\n"); //2.71 => -3.14
    ...
    char* NUM::sprint_fields() const {
        ...
        snprintf(buffer, sizeof(buffer), "S=%lld CE=%s C=%s E=%lld len_I=%lld len_F=%lld", (long long int)S, CE, C, (long long int)E, (long long int)len_I, (long long int)len_F);
	    return buffer;
    }
...
/// NUM OUT-LINE /// RAISE AN ERROR FOR ERROR HANDLER
    ...
    */
    ...
    const char* i64str(i64 num) {
        ...
        char sign = num < 0 ? 1 : 0;
        i64 MIN = (i64) - 9223372036854775807LL - 1;            //-9223372036854775808 (i64);
    ...
    //}
    i64 i64int(const char* n, char** idx, int base) { //DEFAULT ARGs: (I64* idx = 0, i64 base = 10) //CODE: print(i64int("-9223372036854775807", NULL, 10) - 1, "\n"); //-9223372036854775808
        //return stoll(n, idx, base);
        return (i64)strtoll(n, idx, base);
    }
    ...
    char* sprint_fields(NUM& a) {
        static char buffer[128];
	    snprintf(buffer, sizeof(buffer), "S=%lld CE=%s C=%s E=%lld len_I=%lld len_F=%lld", (long long int)a.S, a.CE, a.C, (long long int)a.E, (long long int)a.len_I, (long long int)a.len_F);
